...
case "sepia":
  return {
    palette: {
     ...
     ...makeLight("#7b4b2a", "#a47148"), // deeper warm brown accents
     background: { default: "#e6dac8", paper: "#d9cbb8" }, // softer parchment, less glare
     text: { primary: "#2e261f", secondary: "#5a4f44" },  // darker text for contrast
    },
  };
    default:
      return { palette: makeLight(ACCENT_LIGHT) };
