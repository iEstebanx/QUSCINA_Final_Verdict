  ...
  return (
    <NavLink
      ...
      children={({ isActive }) => (
        <ButtonBase
          sx={(theme) => {
            const selBg = alpha(theme.palette.primary.main, theme.palette.mode === "dark" ? 0.22 : 0.10);
            const hovBg = alpha(theme.palette.text.primary, theme.palette.mode === "dark" ? 0.10 : 0.06);
            return {
              ...base,
              justifyContent: collapsed ? "center" : "flex-start",
              color: isActive ? theme.palette.primary.contrastText : theme.palette.text.primary,
              bgcolor: isActive ? selBg : "transparent",
              "&:hover": { bgcolor: isActive ? selBg : hovBg },
            };
          }}
        >
          <Icon sx={{ fontSize: 20 }} />
    ...
    <Box>
      <ButtonBase
        ...
        sx={(theme) => ({
          ...
          bgcolor: active
            ? alpha(theme.palette.primary.main, theme.palette.mode === "dark" ? 0.22 : 0.10)
            : "transparent",
          justifyContent: collapsed ? "center" : "flex-start",
          "&:hover": {
