...
function NavGroup({
  ...
  return (
    <Box>
      {Row}
      {/* Hide children entirely when sidebar is collapsed */}
      {!collapsed && (
...
export default function Sidebar({
  ...
  // Detect active states for groups by checking current pathname
  ...
  // Local open states (default open when active)
  ...
  // Sync with route changes (so groups open when navigating via deep links)
  // Note: keep it simple (only open if landing inside the section)
  useMemo(() => {
