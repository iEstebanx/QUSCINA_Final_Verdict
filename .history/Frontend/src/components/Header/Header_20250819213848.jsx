...
import { Menu as MenuIcon, LayoutDashboard, Users, ReceiptLong, BarChart2 } from "lucide-react";
...
export default function Header({ collapsed, onToggle, width = 240, collapsedWidth = 72 }) {
  ...
  return (
    ...
    >
      ...
      <Box sx={{ px: 1, display: "grid", gap: 0.5 }}>
        ...
        {/* Add these back later if you enable routes */}
        {/* <NavItem to="/menu" label="Menu" icon={Utensils} collapsed={collapsed} /> */}
        {/* <NavItem to="/shifts" label="Shifts" icon={Clock} collapsed={collapsed} /> */}
